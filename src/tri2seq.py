...
#    process_triples(train_list, 'train_seq',max_sequence_length=128,m=data.num_nodes,r=data.num_rels,history_times=history_times)
    history_times = np.concatenate((test_times), axis=None) #, test_times
#    train_list.extend(test_list)
    process_triples(test_list, 'test_seq', max_sequence_length=128, m=data.num_nodes, r=data.num_rels,
